...
config.General.requestName = 'DisplacedJets_Run2022C_PromptReco_v1_trigger'
config.General.workArea = 'crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'Anl_data_HT_base_cfg.py'

config.Data.inputDataset = '/DisplacedJet/Run2022C-PromptReco-v1/AOD' 
...
config.Data.outputDatasetTag = 'DisplacedJets_Run2022C_PromptReco_v1_trigger'
